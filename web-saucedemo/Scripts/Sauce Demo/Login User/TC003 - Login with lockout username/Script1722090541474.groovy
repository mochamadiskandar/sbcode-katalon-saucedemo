...
WebUI.setText(findTestObject('Sauce Demo/Login page/input_username'), GlobalVariable.lockoutUsername)
...
WebUI.verifyElementVisible(findTestObject('Sauce Demo/Login page/textPopupLoginIsLockout'))
